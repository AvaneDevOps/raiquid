...
/**
 * The one button in Raiquid. Rounded corners (the chamfered "seal chip"
 * shape is for chips only, never buttons).
 *
 * `asChild` renders the styles onto the child element instead of a
 * <button> — use it to style a <Link> as a button without nesting an
 * <a> inside a <button>.
 */
