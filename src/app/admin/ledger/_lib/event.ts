...
// OnChainEvent — { data, page, pageSize, total }. tokenAddress is the
// full address; tokenAddressShort is derived from it here via the
// existing truncateMiddle helper, not a separate real field. Network is
// hardcoded "Ethereum Sepolia" — confirmed directly against
// raiquid-api's config (BRICKKEN_CHAIN_ID defaults to 11155111), not
// either piece of frontend copy that previously disagreed with it.
